...
**New: rif × medium is cmaA2.** 2ΔLL 58.8. Liquid insertions go **up** with rif; solid insertions go **down**. PPE68/esxB rank next, but those bars go **up** on solid+rif — more dispensable, not more required. Don’t write the ESX story.

**Joint tests are not a third kind of biology.** Every joint that includes strain is just the strain sheet again (secA1/manB, β_Rif ≈ 0). They ask “does at least one of these two additive terms matter?” and the louder main wins.
